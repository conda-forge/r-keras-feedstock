...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-keras-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-keras-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-keras-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-keras-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-keras-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-keras-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-keras` can be installed with:

```
conda install r-keras
```

It is possible to list all of the versions of `r-keras` available on your platform with:
